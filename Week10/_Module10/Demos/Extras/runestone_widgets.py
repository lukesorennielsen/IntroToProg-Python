# Downloaded from http://interactivepython.org/runestone/static/thinkcspy/GUIandEventDrivenProgramming/03_widgets.html
# interactivepython.org_runestone_widgets.py
