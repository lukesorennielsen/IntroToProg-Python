# ------------------------------------------------- #
# Title: Demo02 - Using Constructors
# Description: Demonstrates how to use class constructors in your code
...
class Student:
    ...
    # NOTE: We moved the fields into the constructor (which are now called attributes)
